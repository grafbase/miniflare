...
function unimplementedProperty(klass, property) {
...
var unimplementedInitProperties = ["cache"];
    ...
    if (typeof init !== "undefined") {
      for (const unimplementedInitProperty of unimplementedInitProperties) {
        if (init.hasOwnProperty(unimplementedInitProperty)) {
          throw new Error(`Cloudflare Workers does not support the '${unimplementedInitProperty}' property on 'RequestInit'.`);
        }
      }
    }
